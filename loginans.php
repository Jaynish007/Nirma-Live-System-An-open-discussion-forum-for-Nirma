		...
		<section id="main">
			...
			<div class="row">
				...
				<div class="col-2 blong">
					<button type="button" class="btn btn-primary" onclick="document.getElementById('id03').style.display='block'" style="width:auto;">+ ANSWER</button><br><br>
					<hr>
					<div class="bleft">
				...
				<div class="col-10">
					...
					<div class="row">
						<div class="col-8 effect" >
							...
							<form action="allquestion.php" method="post" style="display:inline;"><button type="submit"class="btn btn-info" style="background-color:#1a75ff; ">All Questions</button>&nbsp;&nbsp;&nbsp;&nbsp;</form>
						
						
						</div>
						<div class="col-4 filter" style="margin-top:15px;">
							Filter by:
							<select >
...
<!-------------------------------------Answer-------------------------------->				
				...
				<div id="ans">
					<?php
					$query2="SELECT * FROM ask_question where q_id=$id";
					$data2=mysqli_query($con,$query2);
					while($result=mysqli_fetch_assoc($data2))
							{	echo "<hr class='hrs'>";
								echo "<div class='card2'><b class='que'>".$result['question']."</b><br>";
					...
					?>
					<hr class='hrs'>
					<p style="height:55px;font-size:30px;"><b>ANSWERS</b></p>
					<?php
					$query2="SELECT * FROM answer where q_id=$id";
					$data2=mysqli_query($con,$query2);
					while($result=mysqli_fetch_assoc($data2))
							{	echo "<hr class='hrs'>";
								echo "<div class='card2'><p class='que'>".$result['ans']."</p><br>";

								$a=$result['email'];
	
								$query3="SELECT * FROM registration where email='$a'";
								$data3=mysqli_query($con,$query3);
	
								echo '<ul style="list-style-type:none;padding-top:10px;">';
								echo '<li style="float:left;" ><div style="height:75px;width:75px;"><img src="img_avatar2.png" alt="Avatar" class="avatar"></div></li>';
								while($result2=mysqli_fetch_assoc($data3)){
								echo "<li style='float:left;padding:0;'><div class='tag2'>".$result2['fname']." ".$result2['lname']."</div></li>";
								echo '</ul>';
								}
								echo "<br><br></div>";
							}
...
<!------------------------------------------id03------------------------------------------------->
			<div id="id03" class="modal">
			  ...
			  <form class="modal-content" action="ansdb.php" method="post">
				<div class="container">
				  <h1>ANSWER</h1>
				  <hr>
				  <textarea name="description" rows="10" cols="100" placeholder="Description....."></textarea><br>
					
				  <p>Please do not write any irrelavent answer otherwise it would be removed  <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
